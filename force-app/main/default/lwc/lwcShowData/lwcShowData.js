...
import allRecord from '@salesforce/apex/FieldSetClassLwcAssignment.allRecord';
import { NavigationMixin } from 'lightning/navigation'; 

export default class LwcShowData extends NavigationMixin(LightningElement){
    @api selected;
    @api tableData=[];
   ...
   @api columns;
    ...
    @wire (allRecord,{objectApiNames: '$selected',fieldsetName:'DatatableFields'}) retriveOppData({data,error}){
      if (data) {
